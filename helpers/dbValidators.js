...
/*
    En este fichero se recogen todas las validaciones 
    personalizadas sobre los datos que son mandados a los
...
const categoryValid = async (category) => {
    ...
    if (!validCategories.includes(category)) {
        throw new Error(
            `Category not valid, avaliables categories ${validCategories}`
        )
    }
}
module.exports = {
